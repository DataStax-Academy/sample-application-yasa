...
import com.datastax.yasa.ui.controller.AbstractController;
...
@Controller
@RequestMapping("/c360")
public class Customer360Controller extends AbstractController {

    /** View name. */
    private static final String GRAPH_VIEW      = "c360";
